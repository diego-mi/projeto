...
class Post extends \Post\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Post\\Entity\\Post' . "\0" . 'id', '' . "\0" . 'Post\\Entity\\Post' . "\0" . 'content', '' . "\0" . 'Post\\Entity\\Post' . "\0" . 'type', '' . "\0" . 'Post\\Entity\\Post' . "\0" . 'authorId', '' . "\0" . 'Post\\Entity\\Post' . "\0" . 'date', '' . "\0" . 'Post\\Entity\\Post' . "\0" . 'classification', '' . "\0" . 'Post\\Entity\\Post' . "\0" . 'privacity');
        }
    ...
    public function getPrivacity()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPrivacity', array());

        return parent::getPrivacity();
    }
    ...
    public function setPrivacity($privacity)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPrivacity', array($privacity));

        return parent::setPrivacity($privacity);
    }
